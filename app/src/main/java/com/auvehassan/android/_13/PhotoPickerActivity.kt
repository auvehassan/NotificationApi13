...
/*
Android 13’s new Photo Picker offers several benefits to users and developers:

No runtime permissions needed.
Can easily limit the number of medias picked (min. 1).
Can easily limit the types of medias picked (images, videos, or both).
Uses built-in & standardized UI which is good for user experience.
* */